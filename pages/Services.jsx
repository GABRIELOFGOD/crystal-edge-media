        ...
        <div>
          <div className=" bg-orange-50 py-5 md:py-10 px-6 md:px-24">
            ...
            <div className="w-full flex justify-center">
              <p className="text-light md:w-[800px] text-base text-center">
                {current.def}
              </p>
            </div>
            <div className="flex my-10 md:my-20 mx-6 md:mx-52 md:flex-row flex-col justify-between">
              <div className="text-8xl my-auto text-primary">
                {current.icon}
              </div>
              <div>
                <p className="font-bold mb-5 text-primary text-lg">
                  What we do:
                </p>
            ...
            <div className="flex w-full justify-center">
              <button className="py-3 px-8 text-white bg-primary rounded-full w-fit">
